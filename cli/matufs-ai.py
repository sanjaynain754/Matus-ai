...
class Matufs AIModelsCLIParser:
    """Defines CLI parser for Matufs AI Models CLI"""

    def __init__(self):
        self.parser = argparse.ArgumentParser(
            prog="matufs-ai-model",
            description="Matufs AI Model Management CLI",
            add_help=True,
...
def main():
    parser = Matufs AIModelsCLIParser()
