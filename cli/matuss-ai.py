...
class Matuss AIModelsCLIParser:
    """Defines CLI parser for Matuss AI Models CLI"""

    def __init__(self):
        self.parser = argparse.ArgumentParser(
            prog="matuss-ai-model",
            description="Matuss AI Model Management CLI",
            add_help=True,
...
def main():
    parser = Matuss AIModelsCLIParser()
