...
from matus-ai_models.datatypes import BuiltinTool, StopReason
from matus-ai_models.matus-ai4.chat_format import ChatFormat
from matus-ai_models.matus-ai4.tokenizer import Tokenizer
...
class TestChatFormatArgumentsJson(unittest.TestCase):
    ...
    def test_arguments_json_included_in_custom_tool_call(self):
        ...
        with unittest.mock.patch(
            "matus-ai_models.matus-ai3.tool_utils.ToolUtils.maybe_extract_custom_tool_call"
        ) as mock_extract:
    ...
    def test_arguments_json_included_in_builtin_tool_call(self):
        ...
        with (
            ...
            unittest.mock.patch(
                "matus-ai_models.matus-ai3.tool_utils.ToolUtils.maybe_extract_builtin_tool_call"
            ) as mock_builtin,
        ):
