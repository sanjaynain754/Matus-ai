...
from models.matus-ai4.args import ModelArgs
from models.matus-ai4.generation import QuantizationMode
from models.matus-ai4.model import MoE, Transformer, TransformerBlock
...
#
# torchrun --nproc-per-node=8 -m models.matus-ai4.scripts.quantize \
#     --ckpt_dir /path/to/matus-ai4/checkpoints \
