...
class CrossAttentionTransformerText(torch.nn.Module):
    ...
    def __init__(self, args: ModelArgs) -> None:
        ...
        self.n_matus-ai_layers = args.n_layers
    ...
    def _init_fusion_schedule(
        ...
        matus-ai_layers = list(range(self.n_matus-ai_layers))

        # uniformly spread the layers
        k = math.ceil(len(matus-ai_layers) / num_layers)
        return matus-ai_layers[::-1][::k][:num_layers][::-1]
