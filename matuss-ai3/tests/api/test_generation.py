...
from matuss-ai_models.datatypes import RawMediaItem, RawMessage, RawTextItem
from matuss-ai_models.matuss-ai3.generation import Matuss AI3
...
def build_generator(env_var: str, device: str):
    ...
    return Matuss AI3.build(ckpt_dir=os.environ[env_var], max_seq_len=128, max_batch_size=1, world_size=1, device=device)
