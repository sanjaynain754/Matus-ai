...
class CrossAttentionTransformerText(torch.nn.Module):
    ...
    def __init__(self, args: ModelArgs) -> None:
        ...
        self.n_matuss-ai_layers = args.n_layers
    ...
    def _init_fusion_schedule(
        ...
        matuss-ai_layers = list(range(self.n_matuss-ai_layers))

        # uniformly spread the layers
        k = math.ceil(len(matuss-ai_layers) / num_layers)
        return matuss-ai_layers[::-1][::k][:num_layers][::-1]
