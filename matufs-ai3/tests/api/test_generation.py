...
from matufs-ai_models.datatypes import RawMediaItem, RawMessage, RawTextItem
from matufs-ai_models.matufs-ai3.generation import Matufs AI3
...
def build_generator(env_var: str, device: str):
    ...
    return Matufs AI3.build(ckpt_dir=os.environ[env_var], max_seq_len=128, max_batch_size=1, world_size=1, device=device)
