...
class CrossAttentionTransformerText(torch.nn.Module):
    ...
    def __init__(self, args: ModelArgs) -> None:
        ...
        self.n_matufs-ai_layers = args.n_layers
    ...
    def _init_fusion_schedule(
        ...
        matufs-ai_layers = list(range(self.n_matufs-ai_layers))

        # uniformly spread the layers
        k = math.ceil(len(matufs-ai_layers) / num_layers)
        return matufs-ai_layers[::-1][::k][:num_layers][::-1]
