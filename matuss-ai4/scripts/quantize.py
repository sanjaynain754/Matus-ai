...
from models.matuss-ai4.args import ModelArgs
from models.matuss-ai4.generation import QuantizationMode
from models.matuss-ai4.model import MoE, Transformer, TransformerBlock
...
#
# torchrun --nproc-per-node=8 -m models.matuss-ai4.scripts.quantize \
#     --ckpt_dir /path/to/matuss-ai4/checkpoints \
