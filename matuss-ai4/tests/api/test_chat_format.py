...
from matuss-ai_models.datatypes import BuiltinTool, StopReason
from matuss-ai_models.matuss-ai4.chat_format import ChatFormat
from matuss-ai_models.matuss-ai4.tokenizer import Tokenizer
...
class TestChatFormatArgumentsJson(unittest.TestCase):
    ...
    def test_arguments_json_included_in_custom_tool_call(self):
        ...
        with unittest.mock.patch(
            "matuss-ai_models.matuss-ai3.tool_utils.ToolUtils.maybe_extract_custom_tool_call"
        ) as mock_extract:
    ...
    def test_arguments_json_included_in_builtin_tool_call(self):
        ...
        with (
            ...
            unittest.mock.patch(
                "matuss-ai_models.matuss-ai3.tool_utils.ToolUtils.maybe_extract_builtin_tool_call"
            ) as mock_builtin,
        ):
