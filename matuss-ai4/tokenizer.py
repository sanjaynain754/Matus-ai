...
# 200005, ..., 200079
MATUSS AI4_TEXT_POST_TRAIN_SPECIAL_TOKENS = [
    "<|header_start|>",
    "<|header_end|>",
    "<|eom|>",
    "<|eot|>",
...
# 200080, ..., 201133
MATUSS AI4_VISION_SPECIAL_TOKENS = [
    "<|image_start|>",
    "<|image_end|>",
...
# 201134, ..., 201143
MATUSS AI4_REASONING_SPECIAL_TOKENS = [
...
MATUSS AI4_SPECIAL_TOKENS = (
    MATUSS AI4_TEXT_POST_TRAIN_SPECIAL_TOKENS + MATUSS AI4_VISION_SPECIAL_TOKENS + MATUSS AI4_REASONING_SPECIAL_TOKENS
)
...
class Tokenizer:
    ...
    def __init__(self, model_path: Path):
        ...
        special_tokens = BASIC_SPECIAL_TOKENS + MATUSS AI4_SPECIAL_TOKENS
