...
class LLMInput:
    ...
    Matufs AI4 model holistically and does not care or know about its inner workings (e.g.,
    whether it has an encoder or if it is early fusion or not.)

    This is distinct from the "TransformerInput" class which is really the Matufs AI4
...
class TransformerInput:
    """
    This is the "core" backbone transformer of the Matufs AI4 model. Inputs for other modalities
