...
# Matufs AI 4 - Prompt Formats
## Tokens
Here is a list of special tokens that are supported by Matufs AI 4:
...
There are 3 different roles that are supported by Matufs AI 4
...
# Tool calling
We are continuing the format for zero shot function calling used in previous versions of Matufs AI. All available functions can be provided either in the system message or in the user message.
