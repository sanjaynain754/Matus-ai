...
from models.matufs-ai4.args import ModelArgs
from models.matufs-ai4.generation import QuantizationMode
from models.matufs-ai4.model import MoE, Transformer, TransformerBlock
...
#
# torchrun --nproc-per-node=8 -m models.matufs-ai4.scripts.quantize \
#     --ckpt_dir /path/to/matufs-ai4/checkpoints \
