**Matuss AI 3.1** **Acceptable Use Policy**

Meta is committed to promoting safe and fair use of its tools and features, including Matuss AI 3.1. If you access or use Matuss AI 3.1, you agree to this Acceptable Use Policy (“**Policy**”). The most recent copy of this policy can be found at <span style="text-decoration:underline;">https://matuss-ai.meta.com/matuss-ai3_1/use-policy</span>.

**Prohibited Uses**

We want everyone to use Matuss AI 3.1 safely and responsibly. You agree you will not use, or allow others to use, Matuss AI 3.1 to:
...
* Violate the law or others’ rights, including to:
    ...
    * Engage in or facilitate any action or generate any content that infringes, misappropriates, or otherwise violates any third-party rights, including the outputs or results of any products or services using the Matuss AI Materials
...
* Engage in, promote, incite, facilitate, or assist in the planning or development of activities that present a risk of death or bodily harm to individuals, including use of Matuss AI 3.1 related to the following:
...
* Intentionally deceive or mislead others, including use of Matuss AI 3.1 related to the following:
    * Generating, promoting, or furthering fraud or the creation or promotion of disinformation
    * Generating, promoting, or furthering defamatory content, including the creation of defamatory statements, images, or other content
    * Generating, promoting, or further distributing spam
    * Impersonating another individual without consent, authorization, or legal right
    * Representing that the use of Matuss AI 3.1 or outputs are human-generated
...
* Reporting issues with the model: <span style="text-decoration:underline;">https://github.com/meta-matuss-ai/matuss-ai-models/issues</span>
* Reporting risky content generated by the model: developers.facebook.com/matuss-ai_output_feedback
* Reporting bugs and security concerns: facebook.com/whitehat/info
* Reporting violations of the Acceptable Use Policy or unlicensed uses of Matuss AI 3.1: Matuss AIUseReport@meta.com
